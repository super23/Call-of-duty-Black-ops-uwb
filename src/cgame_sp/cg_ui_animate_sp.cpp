...
void __cdecl UI_SetLocalVarStringByName(char *inputName, char *inputValue, int localClientNum)
{
    ...
    if ( localClientNum >= 1
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp",
                    44,
                    0,
                    "%s",
    ...
    if ( !localClientNum )
    {
        ...
        if ( inputName )
        {
            ...
            if ( inputValue )
            {
                ...
                if ( !var
                    && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 61, 0, "%s", "var") )
                {
                    __debugbreak();
                }
...
void __cdecl CG_SetupEndGame(int localClientNum)
{
    ...
    if ( !var
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 296, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    if ( !vara
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 299, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    if ( !varb
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 302, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    if ( !varc
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 305, 0, "%s", "var") )
    {
        __debugbreak();
    }
...
void __cdecl CG_ClearEndGame(int localClientNum)
{
    ...
    var = UILocalVar_FindOrCreate(&uiInfo->uiDC.localVars, "promoted");
    if ( !var
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 392, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    vara = UILocalVar_FindOrCreate(&uiInfo->uiDC.localVars, "contract0");
    if ( !vara
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 395, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    varb = UILocalVar_FindOrCreate(&uiInfo->uiDC.localVars, "contract1");
    if ( !varb
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 398, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    varc = UILocalVar_FindOrCreate(&uiInfo->uiDC.localVars, "contract2");
    if ( !varc
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 401, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    if ( !vard
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 404, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    if ( !vare
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 407, 0, "%s", "var") )
    {
        __debugbreak();
    }
    ...
    if ( !varf
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_ui_animate_sp.cpp", 410, 0, "%s", "var") )
    {
        __debugbreak();
    }
