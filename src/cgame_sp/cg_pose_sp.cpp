...
#include <client_sp/cl_pose_sp.h>
...
void __cdecl CG_Actor_DoControllers(const cpose_t *pose, const DObj *obj, int *partBits)
{
    ...
    if ( !obj && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_pose_sp.cpp", 520, 0, "%s", "obj") )
        __debugbreak();
...
void __cdecl CG_Player_DoControllers(const cpose_t *pose, const DObj *obj, int *partBits)
{
    ...
    if ( !obj && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_pose_sp.cpp", 170, 0, "%s", "obj") )
        __debugbreak();
...
void    CG_Vehicle_DoControllers(const cpose_t *pose, const DObj *obj, int *partBits)
{
    ...
    if ( !obj && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_pose_sp.cpp", 89, 0, "%s", "obj") )
        __debugbreak();
...
void __cdecl CG_DoBaseOriginController(const cpose_t *pose, const DObj *obj, int *setPartBits)
{
    ...
    if ( !rootBoneCount
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_pose_sp.cpp", 448, 0, "%s", "rootBoneCount") )
    {
        __debugbreak();
    }
...
DObjAnimMat *__cdecl CG_DObjCalcPose(const cpose_t *remote_pose, DObj *obj, int *partBits)
{
    ...
    if ( !obj && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_pose_sp.cpp", 641, 0, "%s", "obj") )
        __debugbreak();
    if ( !remote_pose
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_pose_sp.cpp", 642, 0, "%s", "remote_pose") )
    {
        __debugbreak();
    }
    DObjLock(obj);
