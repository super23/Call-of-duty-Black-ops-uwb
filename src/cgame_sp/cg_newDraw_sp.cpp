...
Material *__cdecl CG_ObjectiveIcon(int localClientNum, int icon, int type)
{
    ...
    if ( type
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp",
                    1540,
                    0,
                    "%s",
                ...
                Material *material)
{
    ...
    if ( !ps && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 3869, 0, "%s", "ps") )
        __debugbreak();
            ...
            if ( cgameGlob->healthOverlayPulseIndex < 4u )
            {
                ...
                if ( healthOverlayPulsePhase )
                {
                    ...
                    else
                    {
                        ...
                        if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 1371, 0, v2) )
                            __debugbreak();
                    }
                }
                else
...
void __cdecl CG_DrawPlayerTargetHighlights(int localClientNum, const rectDef_s *rect, Material *material, float *color)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 3725, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
                ...
                float *color)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 3783, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
    if ( ShouldDrawPlayerTargetHighlights(localClientNum, cgameGlob) )
                ...
                char *text)
{
    ...
    ps = CG_GetPredictedPlayerState(localClientNum);
    if ( !ps && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 4218, 0, "%s", "ps") )
        __debugbreak();
    if ( ps->offhandSecondary >= (unsigned int)PLAYER_OFFHAND_SECONDARIES_TOTAL
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp",
                ...
                float fadeAlpha)
{
    ...
    if ( !rect
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 836, 0, "%s", "rect") )
    {
        __debugbreak();
    }
    width = rect->w;
...
double __cdecl CG_GetClosestTargetToGuidedMissile(int localClientNum)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2135, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
    clientNum = cgameGlob->clientNum;
    ...
    for ( i = 0; i < 32; ++i )
    {
            ...
            && (cent->nextState.lerp.eFlags & 0x40000) == 0 )
        {
            ...
            if ( (const cg_s *)((char *)cgameGlob + v2 * 1480) == (const cg_s *)-389096
                && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2160, 0, "%s", "client") )
            {
                __debugbreak();
            }
...
double __cdecl CG_GetDistanceGuidedMissileAndOwner(int localClientNum)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2187, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
    LocalClientGlobals = CG_GetLocalClientGlobals(localClientNum);
                ...
                int textStyle)
{
    ...
    if ( !rect
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2380, 0, "%s", "rect") )
    {
        __debugbreak();
    }
    if ( !color
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2381, 0, "%s", "color") )
    {
        __debugbreak();
    }
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
                ...
                int style)
{
    ...
    if ( !color
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2475, 0, "%s", "color") )
    {
        __debugbreak();
    }
    if ( !rect
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_newDraw_sp.cpp", 2476, 0, "%s", "rect") )
    {
        __debugbreak();
    }
