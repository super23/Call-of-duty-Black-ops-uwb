...
#include <bgame/bg_vehicles_sp.h>

// Client vehicle helpers — CoDSP_rdBlackOps.map.c:L250927–251277, image RVAs 0x00513140–0x00513A50

//----- (00513140) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  GetVehicleEntDObj
DObj *__cdecl GetVehicleEntDObj(int localClientNum, centity_s *centVeh)
{
    const cgs_t *cgs;
    if ( !centVeh->nextValid
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_vehicles_sp.cpp",
                    60,
                    0,
                    "%s",
                    "centVeh->nextValid") )
...
//----- (005131E0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehEntityUsingVehicle
...
//----- (00513290) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  ClientInfoForEntity
...
//----- (00513340) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehEntityUsingRemoteControlVehicle
...
//----- (00513430) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_GetVehicleInfo
...
//----- (00513450) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehPlayerVehicleSeat
int __cdecl CG_VehPlayerVehicleSeat(int localClientNum, int entNum)
{
    clientInfo_t *ci;
    ci = ClientInfoForEntity(localClientNum, entNum);
    if ( !ci && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_vehicles_sp.cpp", 168, 0, "%s", "ci") )
        __debugbreak();
...
//----- (005134E0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehSeatTransformForPlayer
...
//----- (005135D0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  SeatTransformForClientInfo
void __cdecl SeatTransformForClientInfo(int localClientNum, clientInfo_t *ci, float *resultOrigin, float *resultAngles)
{
    if ( !ci && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_vehicles_sp.cpp", 232, 0, "%s", "ci") )
        __debugbreak();
    if ( ci->attachedVehEntNum == 1023
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_vehicles_sp.cpp",
...
//----- (00513660) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  SeatTransformForSlot
...
//----- (005136E0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  GetTagMatrix
...
//----- (00513880) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetHealthPercentageEntity
...
//----- (005138B0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetHealthPercentageLeftTread
...
//----- (005138E0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetHealthPercentageRightTread
...
//----- (00513910) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetSeatOccupancyFlags
...
//----- (00513930) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetSeatGunTurningYaw
...
//----- (00513990) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetSeatGunTurningPitch
...
//----- (005139F0) --------------------------------------------------------
// Decomp: CoDSP_rdBlackOps.map.c  CG_VehGetSeatGunOverheating
