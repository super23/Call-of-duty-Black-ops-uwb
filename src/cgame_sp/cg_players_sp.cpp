...
void __cdecl CG_AddPlayerSpriteDrawSurfs(int localClientNum, const centity_s *cent)
{
    ...
    if ( cent->nextState.clientNum >= 0x20u
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp",
                    167,
                    0,
...
void CG_AddPlayerSpriteDrawSurf(
    ...
    if (!renderFxFlags || cgameGlob->renderingThirdPerson) {
        ...
        if (fixedScreenSize) {
            renderFlags = 3;
            spriteRadius = (additionalRadiusSize + 5.0f) * 0.0043f;
        }
        else {
            spriteRadius = additionalRadiusSize + 5.0f;
        }
        ...
        sprite.pos[1] = origin[1];
        sprite.pos[2] = origin[2];
        sprite.rgbaColor[0] = 255;
        sprite.rgbaColor[1] = 255;
        sprite.rgbaColor[2] = 255;
        sprite.rgbaColor[3] = 255;
        sprite.radius = spriteRadius;
        sprite.minScreenRadius = (float)cg_headIconMinScreenRadius->current.integer;
        sprite.flags = renderFlags;
...
void __cdecl CG_HighlightPlayer(int localClientNum, centity_s *cent, ShaderConstantSet *constantSet, bool isExtraCam)
{
    ...
    if ( ((*((unsigned int *)cent + 201) >> 1) & 1) != 0 )
    {
        ...
        if ( (const cg_s *)((char *)cgameGlob + clientNum * 1480) == (const cg_s *)-389096
            && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 853, 0, "%s", "client") )
        {
            __debugbreak();
        }
...
void __cdecl CG_ResetPlayerEntity(int localClientNum, cg_s *cgameGlob, centity_s *cent, int resetAnimation)
{
    ...
    if ( (cent->nextState.lerp.eFlags & 0x40000) == 0 && resetAnimation )
    {
        ...
        if ( !pAnimTree
            && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1450, 0, "%s", "pAnimTree") )
        {
            __debugbreak();
        }
        obj = Com_GetClientDObj(cent->nextState.number, localClientNum);
...
const char *__cdecl CG_GetTeamName(team_t team)
{
    ...
    switch ( team )
    {
        ...
        default:
            ...
            if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1501, 0, v2) )
                __debugbreak();
            result = "";
            break;
    }
...
const char *__cdecl CG_GetFFATeamName(ffa_team_t team)
{
    ...
    v2 = va("Unhandled team index %i!", team);
    if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1517, 0, v2) )
        __debugbreak();
    return "";
}
...
const char *__cdecl CG_GetOpposingTeamName(team_t team)
{
    ...
    switch ( team )
    {
        ...
        default:
            v2 = va("Unhandled team index %i!", team);
            if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1535, 0, v2) )
                __debugbreak();
            result = "";
            break;
    }
...
void __cdecl CG_UpdateWeaponVisibilityInternal(int localClientNum, centity_s *cent)
{
    ...
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 2048, 0, "%s", "cent") )
    {
        __debugbreak();
    }
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
...
bool __cdecl CG_IsWeaponVisible(int localClientNum, centity_s *cent, XModel *weapModel, float *origin, float *forward)
{
    ...
    memset(&trace, 0, 16);
    if ( !weapModel
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1996, 0, "%s", "weapModel") )
    {
        __debugbreak();
    }
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1997, 0, "%s", "cent") )
    {
        __debugbreak();
    }
                ...
                float *modelLen)
{
    ...
    if ( !weapModel
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1971, 0, "%s", "weapModel") )
    {
        __debugbreak();
    }
    if ( !modelLen
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 1972, 0, "%s", "modelLen") )
    {
        __debugbreak();
    }
...
bool __cdecl CG_PlayerInViewFrustum(int localClientNum, const centity_s *cent)
{
    ...
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_players_sp.cpp", 2198, 0, "%s", "cent") )
    {
        __debugbreak();
    }
    if ( (_S2_1 & 1) == 0 )
