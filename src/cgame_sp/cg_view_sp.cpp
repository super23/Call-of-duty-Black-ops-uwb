...
void __cdecl CG_UpdateTurretKillCam(int localClientNum)
{
    ...
    if ( !cgameGlob->inKillCam
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp",
                    1541,
                    0,
                    "%s",
                    "cgameGlob->inKillCam") )
...
void __cdecl CG_GetPlayerKillCamEntityLookAt(int localClientNum, float *lookAtPos)
{
    ...
    if ( !lookAtPos
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1374, 0, "%s", "lookAtPos") )
    {
        __debugbreak();
    }
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
...
void __cdecl CG_GetTurretEntityOrgAngles(int localClientNum, float *origin, float *angles)
{
    ...
    if ( !origin
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1508, 0, "%s", "origin") )
    {
        __debugbreak();
    }
    if ( !angles
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1509, 0, "%s", "angles") )
    {
        __debugbreak();
    }
...
void __cdecl CG_UpdateVehicleKillCam(int localClientNum)
{
    ...
    if ( !info && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1628, 0, "%s", "info") )
        __debugbreak();
...
void __cdecl CG_GetKillCamEntityOrgAngles(int localClientNum, float *origin, float *angles)
{
    ...
    if ( !origin
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1387, 0, "%s", "origin") )
    {
        __debugbreak();
    }
    if ( !angles
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1388, 0, "%s", "angles") )
    {
        __debugbreak();
    }
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
...
const vehicle_info_t *__cdecl CG_GetKillCamVehicleInfo(int localClientNum)
{
    ...
    if ( !info && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1592, 0, "%s", "info") )
        __debugbreak();
...
{
    if ( !info && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 1601, 0, "%s", "info") )
        __debugbreak();
...
void __cdecl CG_CalcViewValues(int localClientNum)
{
    ...
    cgameGlob->refdef.blurRadius = sqrtf(
        (float)(CG_GetBlurRadius(localClientNum) * CG_GetBlurRadius(localClientNum))
    ...
    else
    {
        ...
        else
        {
            ...
            // CoDSP_rdBlackOps CG_CalcViewValues: skip error decay for PM_NORMAL_LINKED / pm_type 11.
            if (camMode != CAM_VEHICLE && camMode != CAM_VEHICLE_THIRDPERSON
                && cgameGlob->nextSnap->ps.pm_type != 1
                && cgameGlob->nextSnap->ps.pm_type != 11
...
void __cdecl CG_UpdateKillCamEntity(KillCamEntityType killCamEntityType, int localClientNum)
{
    switch ( killCamEntityType )
    {
        ...
        case KC_TURRET:
            ...
            break;
        default:
            if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 2723, 0, "unreachable") )
                __debugbreak();
            break;
    }
}
    ...
    int renderScreen)
{
    ...
    if (!Sys_IsMainThread()
        && !Assert_MyHandler(
            "c:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\../cgame/cg_colltree.h",
            86,
            0,
            "%s",
            "Sys_IsMainThread()"))
...
void __cdecl CG_CacheKillCamEntityPose(int localClientNum)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 2524, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
    if ( !cgameGlob->inKillCam
...
void __cdecl CG_CacheKillCamLookAtEntityOrigin(int localClientNum)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 2551, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
    if ( !cgameGlob->inKillCam
...
void __cdecl CG_UpdateAdsDof(int localClientNum, GfxDepthOfField *dof)
{
    ...
    memset(&trace, 0, 16);
    if ( !dof && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame_sp\\\cg_view_sp.cpp", 3702, 0, "%s", "dof") )
        __debugbreak();
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    ps = &cgameGlob->predictedPlayerState;
...
void __cdecl CG_StartWaterSheetFX(unsigned int localClientNum, int durationMsec)
{
    ...
    cgameGlob->refdef.waterSheetingFx.scriptEnabled = 1;
    ...
    if ( durationMsec < 0 )
        ...
        cgameGlob->refdef.waterSheetingFx.duration = durationMsec;
}
...
void __cdecl CG_StopWaterSheetFX(unsigned int localClientNum)
{
    ...
    cgameGlob->refdef.waterSheetingFx.scriptEnabled = 0;
    cgameGlob->refdef.waterSheetingFx.duration = 0;
    cgameGlob->refdef.waterSheetingFx.blurRadius = 0.0f;
}
