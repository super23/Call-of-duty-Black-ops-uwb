...
void __cdecl CG_BuildItemList(int localClientNum, const snapshot_s *nextSnap)
{
    ...
    if ( !nextSnap
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 76, 0, "%s", "nextSnap") )
    {
        __debugbreak();
    }
    if ( !Sys_IsMainThread()
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp",
                    77,
                    0,
                    "%s",
                    "Sys_IsMainThread()") )
...
void __cdecl CG_ClearSavedPlayerState(int localClientNum)
{
    ...
    cgameGlob = CG_GetLocalClientGlobals(localClientNum);
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 618, 1, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
...
{
    if ( !cgameGlob
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 102, 0, "%s", "cgameGlob") )
    {
        __debugbreak();
    }
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 103, 0, "%s", "cent") )
    {
        __debugbreak();
    }
...
void __cdecl CG_InterpolatePlayerStateViewAngles(int localClientNum, playerState_s *out, usercmd_s *cmd)
{
    ...
    if ( !prevSnap
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 190, 0, "%s", "prevSnap") )
    {
        __debugbreak();
    }
    if ( !nextSnap
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 191, 0, "%s", "nextSnap") )
    {
        __debugbreak();
    }
...
void __cdecl CG_InterpolatePlayerState(int localClientNum, int grabAngles)
{
    ...
    nextSnap = cgameGlob->nextSnap;
    if ( !prevSnap
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 390, 0, "%s", "prevSnap") )
    {
        __debugbreak();
    }
    if ( !nextSnap
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_predict_sp.cpp", 391, 0, "%s", "nextSnap") )
    {
        __debugbreak();
    }
