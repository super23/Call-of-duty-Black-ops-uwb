...
DObj *__cdecl GetLinkEntDObj(int localClientNum, centity_s *centLink)
{
    if ( ((*((unsigned int *)centLink + 201) >> 1) & 1) == 0
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_animscripted_sp.cpp",
                    12,
                    0,
                    "%s",
                    "centLink->nextValid") )
...
void __cdecl CG_CalcTagParentAxis(int localClientNum, centity_s *cent, float (*parentAxis)[3])
{
    ...
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_animscripted_sp.cpp", 54, 0, "%s", "cent") )
    {
        __debugbreak();
    }
    linkInfo = cent->linkInfo;
    if ( !linkInfo
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_animscripted_sp.cpp", 57, 0, "%s", "linkInfo") )
    {
        __debugbreak();
    }
...
void __cdecl CG_LinkTransformForEntity(int localClientNum, centity_s *cent, float *resultOrigin, float *resultAngles)
{
    ...
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_animscripted_sp.cpp", 89, 0, "%s", "cent") )
    {
        __debugbreak();
    }
...
void __cdecl CG_UpdateFakeEntityLink(int localClientNum, centity_s *cent, int parentNum, int tagIndex)
{
    ...
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_animscripted_sp.cpp", 188, 0, "%s", "cent") )
    {
        __debugbreak();
    }
...
void __cdecl CG_UpdateFakeEntityLink(int localClientNum, centity_s *cent)
{
    ...
    if ( !cent
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\cgame\\\cg_animscripted_sp.cpp", 207, 0, "%s", "cent") )
    {
        __debugbreak();
    }
    if ( cent->nextState.number >= 0x600u
