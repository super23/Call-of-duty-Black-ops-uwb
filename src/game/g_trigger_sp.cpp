...
// Decomp: CoDSP_rdBlackOps.map.c (G_Trigger)
void __cdecl G_Trigger(gentity_s *self, gentity_s *other)
{
    trigger_info_t *trigger_info;

    if ( !self->r.inuse
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\game\\\g_trigger_sp.cpp", 11, 0, "%s", "self->r.inuse") )
    {
        __debugbreak();
    }
    if ( !other->r.inuse
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\game\\\g_trigger_sp.cpp", 12, 0, "%s", "other->r.inuse") )
    {
        __debugbreak();
    }
...
// Decomp: CoDSP_rdBlackOps.map.c (InitTrigger)
...
// Decomp: CoDSP_rdBlackOps.map.c (InitSentientTrigger)
void __cdecl InitSentientTrigger(gentity_s *self)
{
    if ( !self && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\game\\\g_trigger_sp.cpp", 70, 0, "%s", "self") )
        __debugbreak();
    self->r.contents = 0;
...
// Decomp: CoDSP_rdBlackOps.map.c (multi_trigger)
...
// Decomp: CoDSP_rdBlackOps.map.c (Touch_Multi)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_multiple)
...
// Decomp: CoDSP_rdBlackOps.map.c (InitTriggerWait)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_radius)
...
// Decomp: CoDSP_rdBlackOps.map.c (init_trigger_radius)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_radius_use)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_disk)
...
// Decomp: CoDSP_rdBlackOps.map.c (hurt_touch)
void __cdecl hurt_touch(gentity_s *self, gentity_s *other, int __formal)
{
    if ( other->takedamage && self->item[0].index <= level.time )
    {
        ...
        if ( (self->spawnflags & 0x20) != 0 )
        {
            if ( self->handler != 6
                && !Assert_MyHandler(
                            "C:\\projects_pc\\cod\\codsrc\\src\\game\\\g_trigger_sp.cpp",
                            276,
                            0,
                            "%s",
...
// Decomp: CoDSP_rdBlackOps.map.c (hurt_use)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_hurt)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_once)
...
// Decomp: CoDSP_rdBlackOps.map.c (Respond_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (Activate_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (Use_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (Pain_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (Flame_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (Die_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_damage)
...
// Decomp: CoDSP_rdBlackOps.map.c (G_CheckHitTriggerDamage)
void __cdecl G_CheckHitTriggerDamage(gentity_s *pActivator, float *vStart, float *vEnd, int iDamage, unsigned int iMOD)
{
    ...
    if ( !vStart
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\game\\\g_trigger_sp.cpp", 567, 0, "%s", "vStart") )
    {
        __debugbreak();
    }
    if ( !vEnd && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\game\\\g_trigger_sp.cpp", 568, 0, "%s", "vEnd") )
        __debugbreak();
    mins[0] = *vStart;
    mins[1] = vStart[1];
    mins[2] = vStart[2];
...
// Decomp: CoDSP_rdBlackOps.map.c (G_GrenadeTouchTriggerDamage)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_lookat)
...
// Decomp: CoDSP_rdBlackOps.map.c (trigger_ik_playerclip_terrain_touch)
...
// Decomp: CoDSP_rdBlackOps.map.c (SP_trigger_ik_playerclip_terrain)
...
// Decomp: CoDSP_rdBlackOps.map.c (trigger_ik_disable_terrain_mapping_touch)
