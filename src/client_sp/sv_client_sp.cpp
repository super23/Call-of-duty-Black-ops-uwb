...
#include <server_sp/sv_ccmds_sp.h>
#include <stringed/stringed_hooks.h>
#include <DW/MatchRecorder.h>
#include <qcommon/sv_msg_write_mp.h>
#include <server_sp/sv_net_chan_sp.h>
...
void __cdecl SV_CacheClientStatChange(unsigned int clientNum, ddlState_t *searchState)
{
    ...
    if ( clientNum >= com_maxclients->current.integer
        && !Assert_MyHandler(
                    "C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp",
                    496,
                    0,
...
void __cdecl SV_BanClient(client_t *cl)
{
    ...
    if ( !cl && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 997, 0, "%s", "cl") )
        __debugbreak();
                ...
                const char *clientName)
{
    ...
    if ( !client
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 2260, 0, "%s", "client") )
    {
        __debugbreak();
    }
    if ( state < 3
    ...
    if ( !reason
        && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 2262, 0, "%s", "reason") )
    {
        __debugbreak();
    }
    if ( state == 5 )
...
{
    if ( !cl && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 3075, 0, "%s", "cl") )
        __debugbreak();
    cl->downloading = 0;
    if ( cl->download )
        FS_FCloseFile(cl->download);
...
{
    if ( !cl && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 3240, 0, "%s", "cl") )
        __debugbreak();
    SV_Download_Clear(cl);
...
void __cdecl SV_UserinfoChanged(client_t *cl)
{
    ...
    if ( cl->header.netchan.remoteAddress.type )
    {
        ...
        if ( newXuid ) // KISAKTODO: prob should ifdef off this branch
        {
            ...
            if ( !*val
                && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 4153, 0, "%s", "val[0]") )
            {
                __debugbreak();
            }
...
void __cdecl SV_UserMove(client_t *cl, msg_t *msg, int delta)
{
    ...
    if ( cl->reliableSequence - cl->reliableAcknowledge < 128 )
    {
        ...
        if ( cmdCount >= 1 )
        {
            if ( cmdCount <= 32 )
            {
                ...
                if ( !ps
                    && !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 4608, 0, "%s", "ps") )
                {
                    __debugbreak();
                }
        ...
        {
            if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 4580, 0, "cmdCount < 1") )
                __debugbreak();
    ...
    else
    {
        v3 = va(
                     ...
                     cl->reliableAcknowledge,
                     cl->name);
        if ( !Assert_MyHandler("C:\\projects_pc\\cod\\codsrc\\src\\server_sp\\sv_client_sp.cpp", 4572, 0, v3) )
            __debugbreak();
    }
}
